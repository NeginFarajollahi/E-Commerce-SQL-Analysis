...
> **🚧 Status: Active Daily Coding Challenge (Work in Progress)**
...
- [ ] **Day 3:** Category Best-Sellers (`Window Functions`, `PARTITION BY`) - *Coming Tomorrow!*
- [ ] **Day 4:** Customer Retention & Cohort Analysis - *Pending*
